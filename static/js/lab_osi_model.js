...
window.SecurityLabModules["osi_model"] = {
    ...
    references: [
        { source: "ITU-T X.200", title: "Open Systems Interconnection (OSI) Reference Model", url: "https://www.itu.int/rec/T-REC-X.200-199407-I/en", note: "OSI参照モデルの国際標準規格" },
        { source: "RFC 793", title: "Transmission Control Protocol (TCP)", url: "https://datatracker.ietf.org/doc/html/rfc793", note: "トランスポート層プロトコルの仕様" },
        { source: "RFC 791", title: "Internet Protocol (IP)", url: "https://datatracker.ietf.org/doc/html/rfc791", note: "ネットワーク層プロトコルの仕様" },
        { source: "IEEE 802.3", title: "Ethernet Standard", url: "https://standards.ieee.org/standard/802_3-2022.html", note: "物理層・データリンク層イーサネット規格" }
    ],
