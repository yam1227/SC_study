...
window.SecurityLabModules["oauth"] = {
    ...
    references: [
        { source: "RFC 6749", title: "The OAuth 2.0 Authorization Framework", url: "https://datatracker.ietf.org/doc/html/rfc6749", note: "OAuth 2.0の基本仕様書" },
        { source: "RFC 7636", title: "Proof Key for Code Exchange (PKCE)", url: "https://datatracker.ietf.org/doc/html/rfc7636", note: "認可コード横取り攻撃に対する防御仕様" },
        { source: "OpenID Foundation", title: "OpenID Connect Core 1.0", url: "https://openid.net/specs/openid-connect-core-1_0.html", note: "OIDCおよびIDトークンの仕様" },
        { source: "IPA 独立行政法人 情報処理推進機構", title: "API認可設計時におけるセキュリティ対策", url: "https://www.ipa.go.jp/security/technicalwatch/20160629.html", note: "OAuth / OIDC に関するセキュリティ設計ガイド" }
    ],
