...
window.SecurityLabModules["mfa"] = {
    ...
    references: [
        { source: "RFC 6238", title: "TOTP: Time-Based One-Time Password Algorithm", url: "https://datatracker.ietf.org/doc/html/rfc6238", note: "時間ベースのワンタイムパスワード (TOTP) の標準仕様" },
        { source: "RFC 4226", title: "HOTP: An HMAC-Based One-Time Password Algorithm", url: "https://datatracker.ietf.org/doc/html/rfc4226", note: "イベントベースのワンタイムパスワード (HOTP) の標準仕様" },
        { source: "RFC 3548", title: "The Base16, Base32, and Base64 Data Encodings", url: "https://datatracker.ietf.org/doc/html/rfc3548", note: "共有鍵の表現に使用される Base32 を含むエンコーディング仕様" }
    ],
